(function () {
  ...
  function injectShareButton() {
    ...
    if (!actions || right.dataset.sharedButton === '1') return;
    var button = document.createElement('button'); button.className = 'btn btn-secondary'; button.textContent = '공유';
    ...
    actions.appendChild(button); right.dataset.sharedButton = '1';
  }
  async function init() {
